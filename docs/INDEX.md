...
- [Vision and Principles](VISION_AND_PRINCIPLES.md)
...
- [Acceptance Strategy](development/ACCEPTANCE_STRATEGY.md)
- [Core Loop Proof](development/CORE_LOOP_PROOF.md)
- [Versioning and Compatibility](development/VERSIONING.md)

## Governance

- [Public/Private Boundary](governance/PUBLIC_PRIVATE_BOUNDARY.md)
- [Business and Licensing Proposal](governance/BUSINESS_AND_LICENSING.md)
- [Project Decisions](governance/DECISIONS.md)

## Schemas and Templates

- [World seed schema](../schemas/world-seed.schema.json)
- [Resident schema](../schemas/resident.schema.json)
- [Action schema](../schemas/action.schema.json)
- [Event schema](../schemas/event.schema.json)
- [Action and event examples](../examples/contracts/README.md)
